...
# ── Janus Brand Colors (from {{YOUR_DOMAIN}} logo SVG) ───────────────────────────
GOLD        = "#FCAD2A"
DEEP_BLUE   = "#013A7D"
CYAN        = "#028CDC"
DARK_BG     = "#0A1628"
...
/* ── Hero Header (Dark, {{YOUR_DOMAIN}} style) ─────────────────────────────── */
.report-header {{
    background: {DARK_BG};
...
<footer class="report-footer">
  <div class="footer-brand">
    {JANUS_LOGO_SVG}
    <span><span class="gold">Synapse</span> &middot; {{COMPANY_NAME}} &middot; Lysander AI Team</span>
  </div>
